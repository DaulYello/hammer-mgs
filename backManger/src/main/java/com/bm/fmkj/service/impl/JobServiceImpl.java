...
import com.bm.fmkj.dao.JobMapper;
...
public class JobServiceImpl implements IJobService {
	 ...
	 * @return
	 */
	public Pagenation<Job> selectJobList(PageQuery pageQuery) {
		PageHelper.startPage(pageQuery.getPageNo(), pageQuery.getPageSize());
		return PageUtil.toPagedResult(jobMapper.selectJobList(pageQuery.getParam()));
	}
	...
	public int insertJobCron(Job job) {
		job.setCreateBy(job.getUpdateBy());
		job.setStatus(ScheduleConstants.Status.PAUSE.getValue());
